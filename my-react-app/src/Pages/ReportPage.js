    ...
    if (DARKMODE) {
        return (
            <div>
                ...
                ></Box>
                <Container maxWidth="sm" style={{ background: '#216E6B', marginTop: '75px', paddingBottom: '75px' }}>
                    <Grid container spacing={3} direction="column" alignItems="center" justifyContent="center">
                        ...
                        <Grid item xs={12}>
                            ...
                            <Button
                                fullWidth
                                variant="contained"
                                style={{ marginTop: '20px', background: '#009688', color: 'white' }}
                    ...
                    <Grid container spacing={3} direction="column" alignItems="center" justifyContent="center">
                        ...
                        <Grid item xs={12}>
                            ...
                            <Button
                                fullWidth
                                variant="contained"
                                style={{ marginTop: '20px', background: '#b2dfdb', color: 'black' }}
                                onClick={handleIssueSubmit}
                            >
                                Report to Developers
                            </Button>
